...
class AllTasksWidgets extends StatefulWidget {
  const AllTasksWidgets({super.key});

  @override
  State<AllTasksWidgets> createState() => _AllTasksWidgetsState();
}

class _AllTasksWidgetsState extends State<AllTasksWidgets> {
  final user = FirebaseAuth.instance.currentUser;
  late String userid = user!.uid;
  late final _allTasksStream = FirebaseFirestore.instance
      .collection("Tasks")
      .doc(userid)
      .collection("mytasks")
  ...
  late Future<int> count = _allTasksStream.length;
  late Future<int> countDone = _tasksDoneStream.length;
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Padding(
          padding:
              const EdgeInsets.only(bottom: 20, top: 4, left: 15, right: 15),
          child: Row(
        ...
        StreamBuilder(
            ...
            builder: (context, snapshot) {
              ...
              return Column(
                ...
                // Set the font color based on the condition
                ...
                return InkWell(
                  ...
                  child: Padding(
                    padding:
                        const EdgeInsets.only(bottom: 7.0, left: 20, right: 20),
                    child: Container(
